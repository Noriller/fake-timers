...
| `config.warpFactor`              | Number      | 1                                                                                                                                                                                                                              | changes the speed of delays and timeouts by diving all by the factor (factors can't go below 0 and factors smaller than 1 will increase the delays and timeouts)                                                                                                                             |
